    ...
    <>
      <section className=" flex h-screen w-full flex-col items-center justify-center gap-[1rem] bg-[#131324]">
        ...
        >
          ...
          <input
            className=" w-full rounded-lg border bg-transparent p-[1rem] text-[1rem] text-white focus:outline-none "
            type="text"
          ...
          <button
            type="submit"
            className="container   cursor-pointer border  py-[1rem] px-[2rem] text-[1rem] font-bold uppercase text-white"
          >
            Create User
          </button>
