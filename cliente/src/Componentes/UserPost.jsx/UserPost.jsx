...
const userPost = () => {
  ...
  return (
    <div className="mb-5 h-full w-1/2  items-center rounded-lg bg-black py-5">
      <input
        type="text"
        name=""
        id=""
        placeholder="Que estas pensando?"
        className="mx-20 w-1/2 rounded-lg py-1 sm:items-center"
        required
        ref={desc}
      />

      <div className=" flex  w-full ">
        <div className=" mx-20 mt-2 flex  ">
          <label>
            <svg //imagen
